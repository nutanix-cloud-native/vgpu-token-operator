...
import (
	...
	"github.com/nutanix-cloud-native/vgpu-token-operator/internal/controller"
)
...
func main() {
	...
	flag.StringVar(
		&webhookCertPath,
		"webhook-cert-path", "", "The directory that contains the webhook certificate.")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "d9f404ba.nkp.nutanix.com",
